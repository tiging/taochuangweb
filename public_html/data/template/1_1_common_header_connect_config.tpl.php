...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1491924474, '1', './data/template/1_1_common_header_connect_config.tpl.php', './template/default', 'common/header_connect_config')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1491924474, '1', './data/template/1_1_common_header_connect_config.tpl.php', './template/default', 'common/header_connect_config')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1491924474, '1', './data/template/1_1_common_header_connect_config.tpl.php', './template/default', 'common/header_connect_config')
;?>
