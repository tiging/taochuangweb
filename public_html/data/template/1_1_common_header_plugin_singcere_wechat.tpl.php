...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1491752860, '1', './data/template/1_1_common_header_plugin_singcere_wechat.tpl.php', './template/default', 'common/header_plugin_singcere_wechat')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1491752860, '1', './data/template/1_1_common_header_plugin_singcere_wechat.tpl.php', './template/default', 'common/header_plugin_singcere_wechat')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1491752860, '1', './data/template/1_1_common_header_plugin_singcere_wechat.tpl.php', './template/default', 'common/header_plugin_singcere_wechat')
;?>
